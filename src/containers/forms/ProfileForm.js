  ...
  render() {
    ...
    return (
      <Form onSubmit={handleSubmit(onSubmit)}>
        ...
        <LabeledFormField name="email" label={'Email address'} type="email"/>

        { autherror &&
            <FormGroup>
                <Alert bsStyle='danger'>
                    {'Another has already chosen that username. Choose another!'}
                </Alert>
            </FormGroup>
        }

        { update.loadingStatus === 'ok' &&
            <FormGroup>
...
//  return {
//    autherror: state.auth.updateProfile.error,
